...
#define LOG_ERROR(fmt, ...)    LOG_WITH_INIT(spdlog::level::error, "[{}:{}] {}():\t" fmt, __FILENAME__, __LINE__, __func__, ##__VA_ARGS__)
...
#define LOG_ERROR_W(fmt, ...)    LOG_WITH_INIT(spdlog::level::error, L"[{}:{}] {}():\t" fmt, __WFILENAME__, __LINE__, __WFUNCTION__, ##__VA_ARGS__)
